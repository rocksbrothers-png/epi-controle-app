...
from core.audit import register_company_audit as _register_company_audit
...
# Implementação canônica em core.audit (camada sem dependência de `modules`),
# reexportada aqui para os chamadores já existentes deste módulo.
register_company_audit = _register_company_audit
